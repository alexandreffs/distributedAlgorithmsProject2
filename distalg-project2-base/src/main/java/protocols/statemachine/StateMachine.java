 ...
 * the StateMachine and the APPLICATION
 * You can change the requests/notification between the StateMachine and
 * AGREEMENT protocol, however make sure it is
...
public class StateMachine extends GenericProtocol {
    ...
    private void uponLeaderChangeNotification(LeaderChangeNotification notification, short sourceProto) {
        logger.debug("Received notification: " + notification);
        // This is the notification that indicates a leader change in the agreement
        // protocol. You must
        // do the necessary steps to react to this change, which at minimum involves
        // redirecting pending
